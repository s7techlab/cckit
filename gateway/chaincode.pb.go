...
type ChaincodeEvent struct {
	...
	Payload *RawJson             `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`
}
...
var file_chaincode_proto_rawDesc = []byte{
	...
	0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x63, 0x6f,
	0x64, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x1f,
	0x0a, 0x07, 0x52, 0x61, 0x77, 0x4a, 0x73, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22,
	0x86, 0x01, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x45, 0x76, 0x65,
	...
	0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x30, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63, 0x63, 0x6b, 0x69, 0x74, 0x2e,
...
var file_chaincode_proto_goTypes = []interface{}{
	...
	(*peer.Response)(nil),                        // 17: protos.Response
}
var file_chaincode_proto_depIdxs = []int32{
	...
	12, // 22: cckit.gateway.ChaincodeEvent.payload:type_name -> cckit.gateway.RawJson
	3,  // 23: cckit.gateway.ChaincodeService.Exec:input_type -> cckit.gateway.ChaincodeExec
	2,  // 24: cckit.gateway.ChaincodeService.Query:input_type -> cckit.gateway.ChaincodeInput
	2,  // 25: cckit.gateway.ChaincodeService.Invoke:input_type -> cckit.gateway.ChaincodeInput
	5,  // 26: cckit.gateway.ChaincodeService.EventsStream:input_type -> cckit.gateway.ChaincodeEventsStreamRequest
	6,  // 27: cckit.gateway.ChaincodeService.Events:input_type -> cckit.gateway.ChaincodeEventsRequest
	5,  // 28: cckit.gateway.ChaincodeEventsService.EventsStream:input_type -> cckit.gateway.ChaincodeEventsStreamRequest
	6,  // 29: cckit.gateway.ChaincodeEventsService.Events:input_type -> cckit.gateway.ChaincodeEventsRequest
	8,  // 30: cckit.gateway.ChaincodeInstanceService.Exec:input_type -> cckit.gateway.ChaincodeInstanceExec
	7,  // 31: cckit.gateway.ChaincodeInstanceService.Query:input_type -> cckit.gateway.ChaincodeInstanceInput
	7,  // 32: cckit.gateway.ChaincodeInstanceService.Invoke:input_type -> cckit.gateway.ChaincodeInstanceInput
	9,  // 33: cckit.gateway.ChaincodeInstanceService.EventsStream:input_type -> cckit.gateway.ChaincodeInstanceEventsStreamRequest
	10, // 34: cckit.gateway.ChaincodeInstanceService.Events:input_type -> cckit.gateway.ChaincodeInstanceEventsRequest
	9,  // 35: cckit.gateway.ChaincodeInstanceEventsService.EventsStream:input_type -> cckit.gateway.ChaincodeInstanceEventsStreamRequest
	10, // 36: cckit.gateway.ChaincodeInstanceEventsService.Events:input_type -> cckit.gateway.ChaincodeInstanceEventsRequest
	17, // 37: cckit.gateway.ChaincodeService.Exec:output_type -> protos.Response
	17, // 38: cckit.gateway.ChaincodeService.Query:output_type -> protos.Response
	17, // 39: cckit.gateway.ChaincodeService.Invoke:output_type -> protos.Response
	13, // 40: cckit.gateway.ChaincodeService.EventsStream:output_type -> cckit.gateway.ChaincodeEvent
	11, // 41: cckit.gateway.ChaincodeService.Events:output_type -> cckit.gateway.ChaincodeEvents
	13, // 42: cckit.gateway.ChaincodeEventsService.EventsStream:output_type -> cckit.gateway.ChaincodeEvent
	11, // 43: cckit.gateway.ChaincodeEventsService.Events:output_type -> cckit.gateway.ChaincodeEvents
	17, // 44: cckit.gateway.ChaincodeInstanceService.Exec:output_type -> protos.Response
	17, // 45: cckit.gateway.ChaincodeInstanceService.Query:output_type -> protos.Response
	17, // 46: cckit.gateway.ChaincodeInstanceService.Invoke:output_type -> protos.Response
	16, // 47: cckit.gateway.ChaincodeInstanceService.EventsStream:output_type -> protos.ChaincodeEvent
	11, // 48: cckit.gateway.ChaincodeInstanceService.Events:output_type -> cckit.gateway.ChaincodeEvents
	13, // 49: cckit.gateway.ChaincodeInstanceEventsService.EventsStream:output_type -> cckit.gateway.ChaincodeEvent
	11, // 50: cckit.gateway.ChaincodeInstanceEventsService.Events:output_type -> cckit.gateway.ChaincodeEvents
